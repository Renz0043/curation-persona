...
### Phase 1: MVP Infrastructure（環境構築）
- [ ] Firebase & Google Cloud プロジェクト設定
- [ ] Next.js ダッシュボードのベースデプロイ
- [ ] Cloud Scheduler → Cloud Run の疎通確認

### Phase 2: Intelligence Layer（AI連携）
- [ ] Notion APIからのデータ取得
- [ ] Embedding生成 & Vector Search登録
- [ ] Librarian Agentの関連性判定ロジック

### Phase 3: Research Pipeline（自動化）
- [ ] RSS取得の実装
- [ ] Hunter → Librarian → Researcher の連携フロー
- [ ] Firestoreへのレポート保存
